 ...
 * @author kbratko
 */
public final class ExportGenreHandler
  extends BaseExportDomainModelHandler<Integer, GenreDomainModel> {

  public ExportGenreHandler(JList<GenreDomainModel> source,
                            int transferAction,
                            Function<GenreDomainModel, BaseDomainModelTransferable<Integer, GenreDomainModel>> transferableGenerator) {
