...
public class MainView
  ...
  private void initComponents() {
    ...
    layout.setHorizontalGroup(
      ...
      .addComponent(pnlContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 1280, Short.MAX_VALUE)
    );
    layout.setVerticalGroup(
      layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addComponent(pnlContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 720, Short.MAX_VALUE)
    );
  ...
  private void init() {
    pnlContainer.add(LOGIN_VIEW, new LoginView(this));
    pnlContainer.add(REGISTRATION_VIEW, new RegistrationView(this));

    ((CardLayout) pnlContainer.getLayout()).show(pnlContainer, LOGIN_VIEW);
    this.pack();
  }

  @Override
  public void addPanel(String identifier, JPanel panel) {
    pnlContainer.add(identifier, panel);
  }

  @Override
  public void showPanel(String identifier) {
    ((CardLayout) pnlContainer.getLayout()).show(pnlContainer, identifier);
  }
